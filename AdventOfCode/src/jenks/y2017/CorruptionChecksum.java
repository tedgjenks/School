...
public class CorruptionChecksum {
	...
	static final int[][] ROWS = {{104,240,147,246,123,175,372,71,116,230,260,118,202,270,277,292},
	...
	static final int[][] TEST = {{5,1,9,5},
		{7,5,3},
		{2,4,6,8}};
	
	public static void main(String[] args) {
		out.println(computeRowSum(TEST));
		out.println(computeRowSum(ROWS));
	}
	
	private static long computeRowSum(int[][] matrix) {
		long sum = 0;
		for(int oIndex = matrix.length - 1; oIndex >= 0; oIndex--) {
			sum += computeDifference(matrix[oIndex]);
		}
		return sum;
	}
	
	private static int computeDifference(int[] row) {
