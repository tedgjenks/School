...
public interface Scrambler {
	...
	/**
	 * Modifies <code>wordList</code> by replacing each word with its scrambled version, removing any words that are unchanged as a result of scrambling. </br></br>
	 ...
	 * @param wordList the list of words</br>
	 */
